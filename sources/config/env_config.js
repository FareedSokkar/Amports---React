let personal_enviroments = [
    ...
    },
    {
        ...
        configration: {
            list: [
                { id: 'coolors',ip: "external",name: "coolors",path: "coolors.co/palettes/trending",icon: "https://coolors.co/assets/img/favicon.png"},
            ]
        }
    },
    {
        ...
        configration: {
            list: [
                { id: 'calculator',ip: "gt_block",name: "calculator",path: "calculator"},
                {
                    id: 'contact',
                    ip: "gt_build",
                    name: "contact",
